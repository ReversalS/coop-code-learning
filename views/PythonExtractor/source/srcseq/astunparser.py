...
# NOTE: MOD: make it `inf` to keep consistent with `parse_python.py`
INFSTR = "inf"
...
class Unparser:
    ...
    def write(self, text, type=None, node=None):
        ...
        self.f.write(six.text_type(text), type, node)
    ...
    def _ExceptHandler(self, t):
        ...
        if t.name:
            ...
            if six.PY3:
                # NOTE: This is not part of PY2.
                # NOTE: Reason: Use "identifier". Similar to the case of "Global".
                self.write(t.name, type="identifier", node=t)
            else:
    ...
    def _Str(self, t):
        ...
        if six.PY3:
            ...
            if "unicode_literals" not in self.future_imports:
                self.write(repr(t.s), type="Str")
            elif isinstance(t.s, str):
                self.write("b" + repr(t.s), type="Str")
            elif isinstance(t.s, unicode):
                self.write(repr(t.s).lstrip("u"), type="Str")
            else:
    ...
    def _Name(self, t):
        ...
        #   ```
        self.write(t.id, type="Name" + t.ctx.__class__.__name__, node=t)

    def _NameConstant(self, t):
        # NOTE: This is not part of PY2 and will be removed PY3.8+.
        # NOTE: Use class name. Similar to the case of "str".
        self.write(repr(t.value), type="NameConstant", node=t)
    ...
    def _Num(self, t):
        ...
        # NOTE: Original unparser uses `repr()` while py150 `parse_python.py` uses `unicode()`.
        ...
        #   Here we make it consistent with py150.`parse_python.py`.
        repr_n = unicode(t.n)
        if six.PY3:
